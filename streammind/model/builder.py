...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    ...
    if "videollama" in model_name.lower() or 'vlb' in model_name.lower():
        ...
        if 'lora' in model_name.lower() or 'qlora' in model_name.lower():
            ...
            cfg_pretrained = PretrainedConfig.from_pretrained(model_path, token=token)
            # if "/home/v-dingxin" in model_path:
            #     cfg_pretrained.mm_vision_tower = "/home/v-dingxin/blob/clip-vit-large-patch14-336"
            ...
            if 'vicuna' in model_base.lower():
                ...
                tokenizer = transformers.AutoTokenizer.from_pretrained(model_path,cache_dir=None,model_max_length=2048,padding_side="right",use_fast=True,)
    else:
        # Load language model
