...
class MistralForCausalLM_cls(MistralForCausalLM):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            loss_fct = CrossEntropyLoss(weight=torch.tensor([0.15,0.85]).to(shift_logits.device))
...
class Video_Mamba_seq(LightningModule):
    ...
    def forward(self, x, cls_inference = False,cls_training = False,cls_demo = False,frames_features_shape = []):
        ...
        # pdb.set_trace()
        # self.videoid += 1
        # os.mkdir("/home/v-dingxin/videollama2_plus-main/paper/immediate_memory_wuhao_{}".format(self.videoid))
        # torch.save(x,"/home/v-dingxin/videollama2_plus-main/paper/immediate_memory_wuhao_{}/cur_frame_feature.pt".format(self.videoid))
        ...
        if cls_training or cls_inference:
            ...
            for idx, end_frame_idx in enumerate(frames_features_shape):
                ...
                # torch.save(cur_frame_feature,"/home/v-dingxin/videollama2_plus-main/paper/immediate_memory_wuhao_{}/cur_frame_feature_{}.pt".format(self.videoid,idx))
